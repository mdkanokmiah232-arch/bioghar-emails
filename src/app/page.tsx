          ...
          <div className="relative bg-gray-200 border-4 border-gray-400" style={{ height: '280px', width: '600px' }}>
            ...
            <div className="absolute top-3 left-3 right-3 bottom-3 bg-gray-100 border-2 border-gray-300">
              ...
              <div className="absolute top-0 left-0 w-[calc(33.33%-4px)] h-[calc(50%-4px)] bg-blue-100 border-2 border-blue-300 m-1 rounded-lg">
                ...
                {/* Attached Bath */}
                <div className="absolute bottom-0 right-0 w-6 h-8 bg-cyan-100 border border-cyan-300 rounded-tl-lg">
                  <p className="text-[6px] text-center pt-1">Bath</p>
                </div>
              </div>
              ...
              {/* Room 4 */}
              <div className="absolute top-[calc(50%+4px)] left-0 w-[calc(33.33%-4px)] h-[calc(50%-4px)] bg-blue-100 border-2 border-blue-300 m-1 rounded-lg">
                <div className="text-center py-2">
                  <p className="font-bold text-blue-800">Room 4</p>
                  <p className="text-xs text-blue-600">12&apos; × 10&apos;</p>
                </div>
                {/* Attached Bath */}
                <div className="absolute top-0 right-0 w-6 h-8 bg-cyan-100 border border-cyan-300 rounded-bl-lg">
                  <p className="text-[6px] text-center pt-1">Bath</p>
                </div>
              </div>

              {/* Room 5 */}
              <div className="absolute top-[calc(50%+4px)] left-[calc(33.33%+4px)] w-[calc(33.33%-4px)] h-[calc(50%-4px)] bg-blue-100 border-2 border-blue-300 m-1 rounded-lg">
                <div className="text-center py-2">
              ...
              {/* Common Area / Toilet Block */}
              <div className="absolute top-[calc(50%+4px)] left-[calc(66.66%+4px)] w-[calc(33.33%-4px)] h-[calc(50%-4px)] bg-orange-100 border-2 border-orange-300 m-1 rounded-lg">
